...
public class MovieController {
	private static final String RESPONSE_STRING_FORMAT = "movies-v1 => %s\n";
	
	private static final String RESPONSE_STRING_FORMAT_UI = "[{\"name\":\"Avengers EndGame\",\"director\":\"Rusoo Brothers\",\"producer\":\"Kevin Feige\",\"production\":\"Marvel Studios\",\"date\":\"April 26\",\"written\":\"Stan Lee\",\"year\":\"2019\",\"distributed\":\"Walt Disney\",\"poster\":\"assets/img/v1.jpg\",\"VERSION\":1,\"bg-color\":\"background-color: black\"} , %s\n]";
